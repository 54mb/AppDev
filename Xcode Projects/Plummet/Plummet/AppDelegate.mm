...
//  Plummet
//
//  Created by Sam Burton on Thursday, 13 August 2015
//  Copyright (c) Sam Burton. All rights reserved.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString* projectPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Plummet.codea"];
